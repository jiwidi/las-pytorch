...
class Encoder(nn.Module):
    ...
    def forward(self, padded_input, input_lengths):
        ...
        packed_input = pack_padded_sequence(padded_input, input_lengths, batch_first=True, enforce_sorted=False)
...
class Decoder(nn.Module):
    ...
    def forward(self, output, encoder_out, decoder_hidden):
        ...
        context, mask = self.attention(decoder_hidden[-1:], encoder_out)
